...
/**
   ...
   */
export const ScrollAnimation = ({ children, startingPoint = 'top', duration = 1, amount = 100, repeat = false, ...rest }: PropsType) => {
  const { ref, isInViewport } = useScrollAnimation(repeat);
